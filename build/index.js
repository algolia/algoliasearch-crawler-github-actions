...
var crawler_api_client_1 = __nccwpck_require__(626);
...
var iconvLite = __nccwpck_require__(32);
...
module.exports = {
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(803).concat(__nccwpck_require__(419)) },
        gb18030: function() { return __nccwpck_require__(458) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
...
var bomHandling = __nccwpck_require__(961),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __nccwpck_require__(733); // Lazy load all encoding definitions.
...
let convert;
try {
	convert = __nccwpck_require__(685)/* .convert */ .O;
} catch (e) {}
