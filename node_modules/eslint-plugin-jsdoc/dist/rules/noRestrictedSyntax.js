...
var _default = (0, _iterateJsdoc.default)(({
  ...
  const foundContext = contexts.find(cntxt => {
    return cntxt === selector || typeof cntxt === 'object' && (cntxt.context === 'any' || selector === cntxt.context) && comment === cntxt.comment;
  });
  const contextStr = typeof foundContext === 'object' ? foundContext.context : foundContext;
