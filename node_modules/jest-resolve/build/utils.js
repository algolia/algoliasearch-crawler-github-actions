...
const resolveTestEnvironment = ({rootDir, testEnvironment: filePath}) =>
...
const resolveWatchPlugin = (resolver, {filePath, rootDir}) =>
...
const resolveRunner = (resolver, {filePath, rootDir}) =>
  resolveWithPrefix(resolver, {
    filePath,
...
const resolveSequencer = (resolver, {filePath, rootDir}) =>
  resolveWithPrefix(resolver, {
    filePath,
